...
// console.log(createMenuItem('burger', 5, 'sandwich'))
// console.log(createMenuItem('pizza', 6, 'dinner'))
// console.log(createMenuItem('sam adams', 3, 'alcohol'))
...
reviews.push({name: 'Charlie', rating: 5, feedback: 'This is a review.'})  
